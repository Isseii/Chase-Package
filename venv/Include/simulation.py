...
class Simulation:
    ...
    def __toJson(self,sheep_arr, wolf, data, i):
        sheeps_holder = []
    ...
    def __toCsv(self,sheeps,directory):
    ...
    def __simulation(self,rounds, sheep_number, wait, directory):
        ...
        sheeps_alive = []
        data['lea'] = []
        self.__toJson(sheep_arr, wolf, data, 0)
        ...
        for i in range(rounds):
            ...
            logging.info(log)
            print(log)
            self.__toJson(sheep_arr, wolf, data, i + 1)
        ...
        self.__toCsv(sheeps_alive, directory)
